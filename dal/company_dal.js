    ...
    connection.query(query, queryData, function(err, result)  {
        if(err || params.address_id === undefined) {
            ...
            if (params.address_id.constructor === Array){
                ...
                companyAddressData.push([company_id,
                params.address_id]);
            }
...
var companyAddressInsert = function(company_id, addressIdArray,
                                    callback){
    var query = 'INSERT INTO company_address (company_id, address_id)' +
        'VALUES ?';
    var companyAddressData = [];
    ...
    connection.query(query, [companyAddressData], function(err,
    result){
        callback(err, result);
    });
};
